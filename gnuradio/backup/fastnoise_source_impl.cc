...
namespace gr
{
    namespace analog
    {
        ...
        fastnoise_source<T>::make(noise_type_t type, float ampl, long seed, long samples, unsigned int vlen)
        {
            return gnuradio::make_block_sptr<fastnoise_source_impl<T>>(type, ampl, seed, samples, vlen);
        }
        ...
        fastnoise_source_impl<T>::fastnoise_source_impl(noise_type_t type,
                                                        float ampl,
                                                        long seed,
                                                        long samples, unsigned int vlen)
