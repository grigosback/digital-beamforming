...
class randomsampler_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_0_0_0_0.set_title("Input stream")
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0_0_0_0.set_max(i, 10000)
        ...
        self.qtgui_number_sink_0_0_0.set_title("Output stream")
        ...
        for i in range(1):
            ...
            self.qtgui_number_sink_0_0_0.set_max(i, 10000)
        ...
        self.beamforming_randomsampler_py_cc_0_0 = beamforming.randomsampler_py_cc(4,8)
        ...
        # Connections
        ##################################################
        self.connect((self.beamforming_randomsampler_py_cc_0_0, 0), (self.blocks_vector_to_stream_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_number_sink_0_0_0, 0))
        ...
        self.connect((self.blocks_stream_to_vector_0_0, 0), (self.beamforming_randomsampler_py_cc_0_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.blocks_float_to_complex_0_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.qtgui_number_sink_0_0_0_0, 0))
