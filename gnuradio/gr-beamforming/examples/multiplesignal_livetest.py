...
class multiplesignal_livetest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, fc=436e6, mx=4, my=4, n=2):
        ...
        self._theta_2_win = RangeWidget(self._theta_2_range, self.set_theta_2, 'Elevation 2', "counter_slider", float)
        ...
        self._theta_1_win = RangeWidget(self._theta_1_range, self.set_theta_1, 'Elevation 1', "counter_slider", float)
        ...
        self._phi_2_win = RangeWidget(self._phi_2_range, self.set_phi_2, 'Azimut 2', "counter_slider", float)
        ...
        self._phi_1_win = RangeWidget(self._phi_1_range, self.set_phi_1, 'Azimut 1', "counter_slider", float)
        ...
        self._element_separation_win = RangeWidget(self._element_separation_range, self.set_element_separation, 'Element Separation', "counter_slider", float)
        self.top_grid_layout.addWidget(self._element_separation_win, 5, 0, 1, 2)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_win, 6, 1, 1, 1)
        for r in range(6, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.connect((self.blocks_unpacked_to_packed_xx_0, 0), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_unpacked_to_packed_xx_0_0, 0), (self.blocks_null_sink_1, 0))
...
def main(top_block_cls=multiplesignal_livetest, options=None):
    if options is None:
