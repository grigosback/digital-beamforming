...
class beamformer(object):
    ...
    @staticmethod
    def make(mx: "unsigned int", my: "unsigned int") -> "gr::beamforming::beamformer::sptr":
        r"""make(unsigned int mx, unsigned int my) -> beamformer_sptr"""
        return _beamforming_swig.beamformer_make(mx, my)
...
def beamformer_make(mx: "unsigned int", my: "unsigned int") -> "gr::beamforming::beamformer::sptr":
    r"""beamformer_make(unsigned int mx, unsigned int my) -> beamformer_sptr"""
    return _beamforming_swig.beamformer_make(mx, my)
...
class beamformer_sptr(object):
    ...
    def make(self, mx: "unsigned int", my: "unsigned int") -> "gr::beamforming::beamformer::sptr":
        r"""make(beamformer_sptr self, unsigned int mx, unsigned int my) -> beamformer_sptr"""
        return _beamforming_swig.beamformer_sptr_make(self, mx, my)
